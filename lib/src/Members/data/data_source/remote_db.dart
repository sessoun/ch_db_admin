...
class MembersRemoteDb {
  ...
  String? orgName = 'CACI';
//this
  Future<void> initDb(String orgName) async {
    // Add the org name as a field in the autogenerated document
    db = await FirebaseFirestore.instance.collection('organisations').add({
      'orgName': orgName,
    }).then((docRef) {
      // Reference for members collection under autogenerated ID
      db = docRef.collection('members');
      return db;
    });
  }
