...
//this 
  ...
  Future<String> addUser(MemberModel data) async {
    try {
      ...
      throw DatabaseException(e.message ?? 'Error adding member\'s details', code: e.code);
  ...
  Future<MemberModel?> getMemberById(String memberId) async {
    try {
      ...
      throw DatabaseException(e.message ?? 'Error fetching member details', code: e.code);
    } on SocketException catch (e) {
      log('here: $e');
      throw NetworkException(e.message);
    } on Exception catch (e) {
  ...
  Future<String> updateMember(String memberId, MemberModel data) async {
    try {
      ...
      throw DatabaseException(e.message ?? 'Error updating member\'s details', code: e.code);
    } on SocketException catch (e) {
      log('here: $e');
      throw NetworkException(e.message);
    } on Exception catch (e) {
  ...
  Future<String> deleteMember(String memberId) async {
    try {
      ...
      throw DatabaseException(e.message ?? 'Error deleting member', code: e.code);
    } on SocketException catch (e) {
      log('here: $e');
      throw NetworkException(e.message);
    } on Exception catch (e) {
  ...
  Future<List<MemberModel>> getAllMembers() async {
    try {
      ...
      throw DatabaseException(e.message ?? 'Error fetching members list', code: e.code);
    } on SocketException catch (e) {
      log('here: $e');
      throw NetworkException(e.message);
    } on Exception catch (e) {
  ...
  Future<List<MemberModel>> getMembersByName(String name) async {
    try {
      ...
      throw DatabaseException(e.message ?? 'Error fetching members by name', code: e.code);
    } on SocketException catch (e) {
      log('here: $e');
      throw NetworkException(e.message);
    } on Exception catch (e) {
